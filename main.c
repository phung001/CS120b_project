...
int Menu(int states) {
   ...
   switch(state) { // Transitions
      ...
      case Menu_init:
         if (1) {
            state = Menu_main_wait;
         }
         break;
      case Menu_button_wait:
         if (keypad != 2 //else) {
            state = Menu_button_wait;
         }
         else if (keypad == 0) {
            state = Menu_main_wait;
         }
         else if (keypad == 2 //enter) {
            state = Menu_chang_button_wait;
         }
         break;
      case Menu_main_wait:
         if (cursor == 2 && keypad == 2) {
            ...
            state = Menu_record_wait;
         }
         else if (cursor == 0 && keypad == 2) {
            state = Menu_play_wait;
         }
         else if (cursor == 3 && keypad == 2) {
            state = Menu_reset_wait;
         }
         else{
            state = Menu_main_wait;
         }
      ...
      case Menu_record_wait:
         if (keypad == 0) {
            ...
            state = Menu_song1_record;
         }
         else if (cursor == 1 && keypad == 2) {
            state = Menu_song2_record;
         }
         else if (cursor == 2 && keypad == 2) {
            state = Menu_song3_record;
         }
         else if (cursor == 3 && keypad == 2) {
            state = Menu_song4_record;
         }
         else{
            state = Menu_record_wait;
         }
      ...
      case Menu_play_wait:
         if (keypad == 0) {
            ...
            state = Menu_song1_play;
         }
         else if (cursor == 1 && keypad == 2) {
            state = Menu_song2_play;
         }
         else if (cursor == 2 && keypad == 2) {
            state = Menu_song3_play;
         }
         else if (cursor == 3 && keypad == 2) {
            state = Menu_song4_play;
         }
	 else{
            state = Menu_play_wait;
         }
